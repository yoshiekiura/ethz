...
# Database: ethz
# Generation Time: 2018-05-26 01:09:18 +0000
# ************************************************************
...
CREATE TABLE `accounts_details` (
  ...
  `uid` bigint(11) NOT NULL COMMENT '用户id',
  `currency` int(10) unsigned NOT NULL COMMENT '货币id',
  `type` tinyint(4) NOT NULL COMMENT '类型，1：充币，2：交易买入，0：系统操作，-1：提币，-2：交易卖出',
...
VALUES
	(1,2,1,'17pSU1RtBRCz5yJR7dFMsmxAKKG932weJX','','2018-01-29 15:21:30','2018-01-29 15:21:30',1),
	(2,2,2,'0x5c5d723131fe66fdb2af3123fffe89d225bb737c','','2018-01-29 15:21:34','2018-01-29 15:21:34',1),
	(3,5,1,'15i8oARH4QLP3ZbMFiAHPNzUBBjEWDe2HL','','2018-01-29 15:21:45','2018-01-29 15:21:45',1),
	(4,5,2,'0x42538d89d5edfbff2e36668dcbb15dbf9cb46fb0','','2018-01-29 15:21:54','2018-01-29 15:21:54',1),
	(5,6,2,'0x81ce5638cd4d9678436832d61af098128374c2a8','','2018-01-29 15:31:29','2018-01-29 15:31:29',1),
	(6,1,1,'1KL4BdRdpo5DziLCVPMtY912nM4kaPMCzq','','2018-01-29 15:41:51','2018-01-29 15:41:51',1),
	(7,1,2,'0xdc8239cf1dce61883290b1a5847d1074a0b29230','','2018-01-29 15:41:53','2018-01-29 15:41:53',1),
	(8,6,1,'1Pch81TBrFEAFhT3UYT56BW3Q5eA5KFkCv','','2018-01-29 15:45:07','2018-01-29 15:45:07',1),
	(9,4,1,'1AKTRdcWWD8dEKs2JxndLJ2as5zPBPKyak','','2018-01-29 17:05:24','2018-01-29 17:05:24',1),
	(10,4,2,'0x3d65cc4a595e8e1f9e5a8703c15e4da07b067ba2','','2018-01-29 17:05:30','2018-01-29 17:05:30',1);
...
LOCK TABLES `deposits_orders` WRITE;
/*!40000 ALTER TABLE `deposits_orders` DISABLE KEYS */;

INSERT INTO `deposits_orders` (`id`, `uid`, `currency`, `fee`, `amount`, `address`, `txid`, `txout`, `confirmations`, `remark`, `status`, `done_at`, `created_at`, `updated_at`)
VALUES
	(1,1,1,0.000000000000000000,0.100000000000000000,'0x81ce5638cd4d9678436832d61af098128374c2a8','0x979e96f6414a330273517daac3e604074dc2735f20b007154e7cccdd0fecc2bc',1,0,NULL,1,NULL,'2018-01-29 15:32:34','2018-05-18 06:26:13'),
	(3,1,1,0.000000000000000000,20.000000000000000000,'0x81ce5638cd4d9678436832d61af098128374c2a8','',1,0,'充值成功',1,'2018-02-02 12:11:29','2018-01-29 15:32:34','2018-05-18 06:26:14'),
	(5,1,1,0.000000000000000000,20.000000000000000000,'0x81ce5638cd4d9678436832d61af098128374c2a8','3',1,0,'充值成功',1,'2018-02-02 14:11:38','2018-01-29 15:32:34','2018-05-18 06:26:15');

/*!40000 ALTER TABLE `deposits_orders` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `guess` (
  ...
  `expect_price` decimal(30,18) unsigned DEFAULT '0.000000000000000000' COMMENT '竞猜价',
...
INSERT INTO `guess` (`id`, `currency`, `title`, `expect_price`, `max_amount`, `min_amount`, `sum_amount`, `charges`, `start_time`, `end_time`, `open_time`, `period`, `number`, `status`, `created_at`, `updated_at`)
VALUES
	(1,1,'快讯',4680.990000000000000000,10000.000000000000000000,1.000000000000000000,0.000000000000000000,20.000000000000000000,'2018-05-20 15:00:00','2018-05-20 23:00:00','2018-05-21 23:00:00',1,0,1,'2018-05-20 04:38:17','2018-05-20 04:38:17');
...
VALUES
	(1,0,1,1,5000.000000000000000000,10.000000000000000000,'2018-05-26 01:04:31','2018-05-26 01:04:31');
...
VALUES
	...
	(9,'710355249','710355249@qq.com',NULL,'$2y$10$TOBHlw7TDk6obGiyCIdUou82gNQVIjmgde1/KMCGYX0b5dFkA62jO','4',NULL,0,6,'5B089E73D1D5C',NULL,'127.0.0.1',0,'2018-05-26 07:38:28','2018-05-26 07:38:28');
